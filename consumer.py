...
conf = {
    'bootstrap.servers': '172.16.250.13:9092,172.16.250.14:9092,172.16.250.15:9092,172.16.250.16:9092,'
                                ...
                                '172.16.250.21:9092',  # Replace with your Kafka broker(s) address
    'group.id': 'japa4',       # Consumer group ID
    ...
    try:
        ...
        while True:
            ...
            if msg.error():
                ...
                data_string = f"japa4{{house_id=\"{house_id}\", season=\"{season}\", month=\"{month}\"}} {kwh} {timestamp_s}"
